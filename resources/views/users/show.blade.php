...
<html lang="{{ str_replace("_", "-", app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="footer">
            <a href="/users" class="back"><i class="fa-solid fa-arrow-right-to-bracket"></i>    戻る</a>
            ...
            <h3>コメント</h3>
                ...
                @endforeach
            <a href = '/users/{{$post->id}}/comments'class="comments"><i class="fa-solid fa-comments">すべてのコメントを見る</i></a>
        </div>
    </body>
</html>
@endsection
