...
Route::get("/ranking/create/pg/players/{id}", "RankingController@pgSelectAjax");
Route::get("/ranking/create/sg/teams/{team_id}", "RankingController@sgTeamSelectAjax");
Route::get("/ranking/create/sg/players/{id}", "RankingController@sgSelectAjax");
Route::get("/ranking/create/sf/teams/{team_id}", "RankingController@sfTeamSelectAjax");
Route::get("/ranking/create/sf/players/{id}", "RankingController@sfSelectAjax");
Route::get("/ranking/create/pf/teams/{team_id}", "RankingController@pfTeamSelectAjax");
Route::get("/ranking/create/pf/players/{id}", "RankingController@pfSelectAjax");
Route::get("/ranking/create/c/teams/{team_id}", "RankingController@cTeamSelectAjax");
Route::get("/ranking/create/c/players/{id}", "RankingController@cSelectAjax");
